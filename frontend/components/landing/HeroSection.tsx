      ...
      <div className="container relative z-10 px-4 text-center">
        ...
        >
          <Link href="/auth">
            <Button
              size="lg"
              className="h-14 px-10 text-lg font-bold rounded-full bg-white text-black hover:bg-gray-200 transition-all hover:scale-105"
            >
              Claim Your Username
            </Button>
          </Link>
          <Button
            size="lg"
            variant="outline"
            className="h-14 px-8 text-lg font-bold rounded-full border-white/10 bg-white/5 text-white hover:bg-white/10 transition-all"
            onClick={() =>
