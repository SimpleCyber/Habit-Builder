...
export function HistoryList({ history }: HistoryListProps) {
  ...
  if (history.length === 0) {
    return <p className="text-gray-500 dark:text-gray-400 text-center py-4">No history yet. Start checking in!</p>
  }
          ...
          return (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <p className="text-sm font-medium text-gray-900 dark:text-white">{entry.text}</p>
