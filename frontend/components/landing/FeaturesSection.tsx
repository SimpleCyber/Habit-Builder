      ...
      <div className="container px-4 mx-auto">
        <div className="mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-2xl">
            We combined the best parts of habit tracking with the addictive nature of social media.
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-min">
            ...
            <div className="md:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-white/5 transition-colors hover:bg-white/10 hover:border-white/20">
                <div className="p-8 pb-0">
                    ...
                    <p className="text-gray-400 max-w-md">Your profile is your resume of discipline. Share your graph with the world and prove your consistency.</p>
                </div>
                                ...
                                {Array.from({ length: 5 }).map((_, d) => (
                                    <div 
                                        ...
                                        className={`w-4 h-4 rounded-sm ${
                                            ...
                                            Math.random() > 0.3 ? "bg-green-900" : "bg-white/5"
                                        }`} 
                                    />
                                ))}
                             </div>
            ...
            <div className="relative group overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 transition-colors hover:bg-white/10 hover:border-white/20 flex flex-col justify-between">
                <div>
                    ...
                    <p className="text-gray-400">Post your daily wins. Get kudos. Build momentum together.</p>
                </div>
                {/* Visual: Mini Tweet */}
                <div className="mt-6 p-4 rounded-xl bg-[#0A0A0A] border border-white/5">
                    <div className="flex gap-3">
                         <div className="w-8 h-8 rounded-full bg-blue-500 text-[10px] flex items-center justify-center font-bold">JD</div>
            ...
            <div className="relative group overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 transition-colors hover:bg-white/10 hover:border-white/20 flex flex-col justify-between">
                 <div>
                    ...
                    <p className="text-gray-400">Compete with friends or globally. See who can hold the longest streak.</p>
                </div>
            ...
            <div className="md:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-white/5 transition-colors hover:bg-white/10 hover:border-white/20">
                <div className="p-8 pb-0">
                    ...
                    <h3 className="text-2xl font-bold mb-2">Instant Sync & Offline First</h3>
                     <p className="text-gray-400 max-w-md">Works everywhere. Updates instantly. Whether you're on the subway or at your desk, never miss a log.</p>
                </div>
                    ...
                    <div className="w-40 h-32 bg-[#0A0A0A] border border-white/10 rounded-t-xl p-2 flex flex-col gap-2">
                        <div className="w-full h-1 bg-white/10 rounded-full" />
                         <div className="flex items-center gap-2">
                            ...
                            <div className="text-[10px] text-gray-500">Synced just now</div>
                         </div>
                    </div>
                </div>
            </div>
