        ...
        <div className="grid gap-8 lg:grid-cols-4">
          <div className="lg:col-span-1">
            <Link href="/" className="text-xl font-bold tracking-tighter flex items-center gap-2">
              ...
              <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">HabitX</span>
            </Link>
            <p className="mt-4 text-sm text-muted-foreground">
              Empowering you to build lasting habits and achieve your full potential.
            </p>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:col-span-3 lg:grid-cols-3">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="#" className="text-sm text-muted-foreground hover:text-primary">Legal</Link></li>
              </ul>
            </div>
          </div>
        </div>
