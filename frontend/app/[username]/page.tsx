                                ...
                                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Button 
                                            variant="outline" 
                                            size="icon" 
                                            className="rounded-xl h-10 w-10 glass-effect"
                                            onClick={handleShare}
                                            title="Share Profile"
                                        >
...
function SocialLink({ platform, href }: { platform: string; href: string }) {
    ...
    return (
        <a 
            ...
            className="w-10 h-10 flex items-center justify-center rounded-xl bg-background text-muted-foreground hover:bg-muted hover:text-orange-500 transition-all border border-border shadow-sm hover:scale-105 active:scale-95"
            title={platform}
        >
