      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 bg-[#050505] border-r border-white/5 overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-gray-400 text-lg mb-8">
            "HabitX changed the way I look at my daily routine. It's not just a
            tracker, it's a lifestyle."
          </p>
          ...
          <div className="flex items-center gap-4">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className={`w-10 h-10 rounded-full border-2 border-[#050505] bg-gray-700 flex items-center justify-center overflow-hidden`}
                >
