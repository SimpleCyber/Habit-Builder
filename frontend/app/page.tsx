  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white selection:bg-green-500/30">
      ...
      <main>
        ...
        {/* Final CTA */}
        <section className="py-24 border-t border-white/5 bg-gradient-to-b from-[#0A0A0A] to-[#111]">
            <div className="container px-4 mx-auto text-center">
                <h2 className="text-4xl sm:text-5xl font-bold mb-6 tracking-tight">
                    Start your streak today.
                </h2>
                <p className="text-gray-400 mb-8 text-lg max-w-xl mx-auto">
                    Join thousands of high performers building the future of their habits.
                </p>
                <Link href="/auth">
                    <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-green-500 hover:bg-green-600 text-white font-bold transition-all hover:shadow-[0_0_20px_rgba(34,197,94,0.4)]">
